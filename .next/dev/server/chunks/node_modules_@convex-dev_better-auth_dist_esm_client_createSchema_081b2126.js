module.exports = [
"[project]/node_modules/@convex-dev/better-auth/dist/esm/client/createSchema.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const specialFields = (tables)=>Object.fromEntries(Object.entries(tables).map(([key, table])=>{
        const fields = Object.fromEntries(Object.entries(table.fields).map(([fieldKey, field])=>[
...
const createSchema = async ({ file, tables })=>{
...
//# sourceMappingURL=node_modules_%40convex-dev_better-auth_dist_esm_client_createSchema_081b2126.js.map