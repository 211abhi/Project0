...
function SignInPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setIsLoading(true);
        setError(null);
        const { data, error: signInError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authClient"].signIn.email({
            email,
            password
        }, {
            onSuccess: ()=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__96aa7ccf._.js.map